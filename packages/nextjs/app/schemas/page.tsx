...
>>>>>>> 027440049ffe6c5fa73669819b012d793dc55991
...
=======
      ...
      <div className="flex justify-center space-x-4 mb-8">
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1.5 px-3 rounded-full m-1"
          onClick={handleCreatePortal}
          disabled={isPortalCreating}
        >
          {isPortalCreating ? "Creating Portal..." : "Add Portal"}
        </button>
      </div>
